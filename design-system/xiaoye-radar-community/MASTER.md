...
**Project:** Xiaoye Radar Community
**Reviewed:** 2026-09-06
**Category:** Local-first developer desktop tool
...
- **Mood:** focused, technical, readable, and local-first
- **Runtime rule:** do not fetch remote fonts; use the stacks in `styles.css` so the packaged renderer remains offline and satisfies its CSP.
